...
- (void)viewDidLoad {
    ...
    //TABLE VIEW
    myTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, 320, 430) style:UITableViewStylePlain];
...
- (void) searchTableView:(NSString *)theText {
	...
	VPIAppDelegate *appDelegate = (VPIAppDelegate *)[[UIApplication sharedApplication] delegate];
