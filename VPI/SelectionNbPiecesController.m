...
- (void)viewDidLoad {
	...
	NSArray *type1 = [NSArray arrayWithObjects: @"1 piece", @"2 pieces", @"3 pieces", @"4 pieces", @"+5 pieces", nil];
    ...
    if (nb_pieces_maxi != @"") {
        ...
        NSIndexPath *path = [NSIndexPath indexPathWithIndexes:indexArr2 length:2];
        [rowSelected addObject:path];
        [rowSelectedValue addObject:@""];
    }*/
    ...
    [boutonRetour setFrame:CGRectMake(230,10,50,30)];
