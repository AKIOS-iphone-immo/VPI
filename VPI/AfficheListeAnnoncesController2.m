...
- (void)viewDidLoad
{
	...
	[boutonPrix setFrame:CGRectMake(40, 100, 120, 30)];
	...
	[boutonSurface setFrame:CGRectMake(162, 100, 120, 30)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
        ...
        for (UIImageView *cellIv in cell.imageView.subviews) {
            [cellIv removeFromSuperview];
        }
    ...
    [myAccessoryButton setImage:[UIImage imageNamed:@"fleche.png"] forState:UIControlStateNormal];
    ...
    NSString *prix = [uneAnnonce valueForKey:@"prix"];
	...
	NSString *nbPieces = [uneAnnonce valueForKey:@"nbPieces"];
	...
	NSString *subTitle = [[NSString alloc] initWithFormat:@"%@ m² - %@ piece%@",surface,nbPieces,isS];
...
- (void) loadImage:(NSArray *)tableau{
    ...
    if ([string length] > 0) {
        ...
        NSString *urlString = [NSString stringWithFormat:@"%@",[images objectAtIndex:0]];
